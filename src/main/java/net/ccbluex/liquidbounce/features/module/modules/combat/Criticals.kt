...
class Criticals : Module() {
    ...
    val modeValue = ListValue("Mode", arrayOf("Jartex", "Packet", "Packet2", "NCPPacket", "NoGround", "Redesky", "AACv4", "Hop", "TPHop", "Jump", "Visual", "Edit", "MiniPhase", "NanoPacket", "Non-Calculable", "Invalid", "Verus"), "Packet")
