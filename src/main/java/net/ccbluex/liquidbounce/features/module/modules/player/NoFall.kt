...
class NoFall : Module() {
    val typeValue = ListValue("Type", arrayOf("Edit", "Packet", "MLG", "AAC", "Spartan", "CubeCraft", "Hypixel", "Phase", "Verus", "Medusa", "Motion", "Matrix", "Vulcan", "Jartex"), "Edit")
    ...
    fun onPacket(event: PacketEvent) {
        ...
        if (packet is C03PacketPlayer) {
            ...
            if (typeValue.get().equals("jartex", true) && needSpoof) {
                packet.onGround = true
                needSpoof = false
            }
