...
import net.ccbluex.liquidbounce.features.module.modules.movement.NewSpeed;
...
public class Scaffold extends Module {
    ...
    public void onEnable() {
        ...
        if (autoDisableSpeedValue.get() && LiquidBounce.moduleManager.getModule(NewSpeed.class).getState()) {
            LiquidBounce.moduleManager.getModule(NewSpeed.class).setState(false);
    ...
    public void onUpdate(final UpdateEvent event) {
        ...
        if (shouldGoDown) {
            ...
            if ((!autoJumpValue.get() && !(smartSpeedValue.get() && LiquidBounce.moduleManager.getModule(NewSpeed.class).getState())) || GameSettings.isKeyDown(mc.gameSettings.keyBindJump) || mc.thePlayer.posY < launchY) launchY = (int) mc.thePlayer.posY;
            if (autoJumpValue.get() && !LiquidBounce.moduleManager.getModule(NewSpeed.class).getState() && MovementUtils.isMoving() && mc.thePlayer.onGround && mc.thePlayer.jumpTicks == 0) {
                mc.thePlayer.jump();
    ...
    private void findBlock(final boolean expand) {
        final BlockPos blockPosition = shouldGoDown ? (mc.thePlayer.posY == (int) mc.thePlayer.posY + 0.5D ? new BlockPos(mc.thePlayer.posX, mc.thePlayer.posY - 0.6D, mc.thePlayer.posZ)
                ...
                (!towerActivation() && (sameYValue.get() || ((autoJumpValue.get() || (smartSpeedValue.get() && LiquidBounce.moduleManager.getModule(NewSpeed.class).getState())) && !GameSettings.isKeyDown(mc.gameSettings.keyBindJump))) && launchY <= mc.thePlayer.posY ? (new BlockPos(mc.thePlayer.posX, launchY - 1, mc.thePlayer.posZ)) :
    ...
    private void place(boolean towerActive) {
        ...
        if (!towerActivation() && (!delayTimer.hasTimePassed(delay) || (smartDelay.get() && mc.rightClickDelayTimer > 0) || ((sameYValue.get() || ((autoJumpValue.get() || (smartSpeedValue.get() && LiquidBounce.moduleManager.getModule(NewSpeed.class).getState())) && !GameSettings.isKeyDown(mc.gameSettings.keyBindJump))) && launchY - 1 != (int) (towerActive ? towerPlace : targetPlace).getVec3().yCoord)))
            return;
        ...
        for (int i = 0; i < ((modeValue.get().equalsIgnoreCase("Expand") && !towerActivation()) ? expandLengthValue.get() + 1 : 2); i++) {
            final BlockPos blockPos = new BlockPos(
                ...
                (!towerActivation() 
                    && (sameYValue.get() || 
                        ((autoJumpValue.get() || 
                            (smartSpeedValue.get() && LiquidBounce.moduleManager.getModule(NewSpeed.class).getState())) 
