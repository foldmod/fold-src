...
object LiquidBounce {
    ...
    // Client information
    const val CLIENT_NAME = "Fold"
    const val CLIENT_VERSION = "1.0"
    const val CLIENT_CREATOR = "CCBlueX, exit-scammed, Bing"
    const val CLIENT_CLOUD = "https://foldclientdev.github.io/LiquidCloud/LiquidBounce"
    ...
    fun startClient() {
        ...
        ClientUtils.getLogger().info("Finished loading Fold in ${System.currentTimeMillis() - lastTick}ms.")
