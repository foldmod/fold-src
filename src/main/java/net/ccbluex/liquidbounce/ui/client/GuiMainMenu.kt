...
class GuiMainMenu : GuiScreen(), GuiYesNoCallback {
    ...
    val bigLogo = ResourceLocation("fold/big.png")
    val darkIcon = ResourceLocation("fold/menu/dark.png")
    val lightIcon = ResourceLocation("fold/menu/light.png")
    ...
    enum class ImageButton(val buttonName: String, val texture: ResourceLocation) {
        Single("Singleplayer", ResourceLocation("fold/menu/singleplayer.png")),
        Multi("Multiplayer", ResourceLocation("fold/menu/multiplayer.png")),
        Alts("Alts", ResourceLocation("fold/menu/alt.png")),
        Settings("Settings", ResourceLocation("fold/menu/settings.png")),
        Mods("Mods/Customize", ResourceLocation("fold/menu/mods.png")),
        Exit("Exit", ResourceLocation("fold/menu/exit.png"))
    }

    enum class ExtendedImageButton(val buttonName: String, val texture: ResourceLocation) {
        Back("Back", ResourceLocation("fold/clickgui/back.png")),
        Mods("Mods", ResourceLocation("fold/menu/mods.png")),
        Scripts("Scripts", ResourceLocation("fold/clickgui/docs.png")),
        DiscordRPC("Discord RPC", ResourceLocation("fold/menu/discord.png")),
        Background("Background", ResourceLocation("fold/menu/wallpaper.png")),
        Exit("Exit", ResourceLocation("fold/menu/exit.png"))
    }

    enum class ExtendedBackgroundButton(val buttonName: String, val texture: ResourceLocation) {
        Back("Back", ResourceLocation("fold/clickgui/back.png")),
        Enabled("Enabled", ResourceLocation("fold/notification/new/checkmark.png")),
        Particles("Particles", ResourceLocation("fold/clickgui/brush.png")),
        Change("Change wallpaper", ResourceLocation("fold/clickgui/import.png")),
        Reset("Reset wallpaper", ResourceLocation("fold/clickgui/reload.png")),
        Exit("Exit", ResourceLocation("fold/menu/exit.png"))
    }
