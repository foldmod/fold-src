...
class Text(x: Double = 10.0, y: Double = 10.0, scale: Float = 1F,
    ...
    companion object {
        ...
        fun defaultClient(): Text {
            val text = Text(x = 4.0, y = 4.0, scale = 1F)

            text.displayString.set("%clientName% [%portalVersion%] [%fps%fps] [%ping%ms]")
    ...
    private val bgalphaValue = IntegerValue("Background-Alpha", 0, 0, 255)
